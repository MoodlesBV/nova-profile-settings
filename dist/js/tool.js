...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _context.next = 3;
                                return Nova.request().get('/nova-vendor/runlinenl/nova-profile-tool');
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                                ...
                                $toasted.show(success_message_locale, { type: 'success' });
        ...
        createRequest: function createRequest() {
            return Nova.request().post('/nova-vendor/runlinenl/nova-profile-tool', this.createResourceFormData());
        },
